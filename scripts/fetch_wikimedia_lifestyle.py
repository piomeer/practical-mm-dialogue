#!/usr/bin/env python3
"""Fetch lifestyle photos from Wikimedia Commons into data/生活场景/.

Bulk alternative to Unsplash (which is rate-limited Demo API and kept as supplement).
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Wikimedia Commons → data/生活场景/")
